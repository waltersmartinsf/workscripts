function [Wefica, ISRef, icasig, Wsymm, ISRsymm, status]=efica(X, ini, g, SaddleTest)
%EFICA: [Wefica, ISRef, icasig, Wsymm, SIRsymm, status]=efica(X, ini, g, SaddleTest)
% 
% version: 1.9  release: 30.11.2006
%
%          %improved speed
%
%Input data:
...
% icasig - separated signals (independent components)
...
eficaGaussianNL='ggda';  %Nonlinearity used for eficagaussian signals 'gaus'-'ggda'-'npnl'-'rfsg'
status=0;
